...
namespace DaitationProject.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(UserModel objmodel)
        {
            ...
            {
                DaitationProject.Entity.User objentity = new Entity.User();
                objentity.CreatedOn = System.DateTime.Now;
                objentity.IsActive = true;
                objentity.Name = objmodel.Name;
                objentity.address = objmodel.address;
                objentity.Email = objmodel.Email;
                objentity.Mobile = objmodel.Mobile;
                objentity.RoleID = 2;
        ...
        public ActionResult CreateLogin(UserModel objmodel)
        {
            ...
            if (result != null)
            {
                ...
                MySession.Current.RoleID = result.RoleID;
